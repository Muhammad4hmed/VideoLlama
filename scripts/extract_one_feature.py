...
def main():
    ...
    action='/home/waleed/ahmed/LLM/Half_Vids//P05/cam01/P05_juice.mp4'
    video_path = action
    cam='/home/waleed/ahmed/LLM/Half_Vids//P05/cam01/'
    ...
    if counter % 1 == 0:  # Save after every 512 videos, update this number as per your requirements
