        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                gr.Examples(examples=[
                    [f"{cur_dir}/demo_sample_videos/rgb-01-1.avi", "rgb-01-1"],
                    [f"{cur_dir}/demo_sample_videos/rgb-01-2.avi", "rgb-01-2"],
                    [f"{cur_dir}/demo_sample_videos/rgb-03-2.avi", "rgb-03-2"],
                    [f"{cur_dir}/demo_sample_videos/rgb-05-2.avi", "rgb-05-2"],
                    [f"{cur_dir}/demo_sample_videos/rgb-10-2.avi", "rgb-10-2"],
                    [f"{cur_dir}/demo_sample_videos/rgb-27-2.avi", "rgb-27-2"],
                    [f"{cur_dir}/demo_sample_videos/rgb-15-2.avi", "rgb-15-2"],
                    [f"{cur_dir}/demo_sample_videos/rgb-18-2.avi", "rgb-18-2"],
                    [f"{cur_dir}/demo_sample_videos/rgb-24-2.avi", "rgb-24-2"],
                    [f"{cur_dir}/demo_sample_videos/rgb-11-2.avi", "rgb-11-2"],
                ...
                with gr.Accordion("Parameters", open=False, visible=False) as parameter_row:
                    temperature = gr.Slider(minimum=0.0, maximum=1.0, value=0.2, step=0.1, interactive=True,
                                            label="Temperature", )
                    max_output_tokens = gr.Slider(minimum=0, maximum=2048, value=2048, step=64, interactive=True,
