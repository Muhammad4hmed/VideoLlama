...
from transformers import AutoTokenizer, CLIPVisionModel, CLIPImageProcessor, AutoConfig
...
def load_video(vis_path, n_clips=1, num_frm=1000):
    """
    ...
    frame_idx, seg_size = get_seq_frames(total_frame_num, total_num_frm)
    ...
    return clip_imgs, seg_size, total_frame_num
...
def initialize_model(model_name, projection_path=None):
    ...
    if projection_path:
        ...
        weights = torch.load(projection_path, map_location='cpu')
        # new_weights = {}
        # for k, v in weights.items():
        #     new_weights[k.replace("base_model.model.", "")] = v
